...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tasksContainer = __webpack_require__(201);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _addTaskAction = __webpack_require__(204);

	var _dragDropAction = __webpack_require__(205);
	...
	var TasksContainer = function (_Component) {
	  _inherits(TasksContainer, _Component);

	  function TasksContainer(props) {
	    _classCallCheck(this, TasksContainer);

	    var _this = _possibleConstructorReturn(this, (TasksContainer.__proto__ || Object.getPrototypeOf(TasksContainer)).call(this, props));
	  ...
	  _createClass(TasksContainer, [{
	    ...
	    value: function _sort(a, b) {
	      ...
	      if (aA === bA) {
	        ...
	        // if just a alphabetic string
	        return aA.localeCompare(bA);
	      }
	    }
	  }, {
	    key: 'drag',
	    value: function drag(task, event) {
	      event.preventDefault();
	    }
	  }, {
	    key: 'dragover',
	    ...
	    value: function drop(event) {
	      ...
	      event.preventDefault();
	      debugger;
	      var elem = event.target.nodeName == 'LI' ? event.target.parentElement.parentElement : event.target.parentElement;
	      var cls = elem.getAttribute('class') != null ? elem.getAttribute('class').split(' ')[1] : '';
	      switch (cls) {
	        case 'progress':
	    ...
	    key: 'dragStart',
	    value: function dragStart(task, event) {
	    ...
	    value: function render() {
	      ...
	      var sortedTasks = this.props.tasks.sort(function (a, b) {
	        return _this2._sort(a, b);
	      });
	      var todoTasks = sortedTasks.filter(function (task, key) {
	        return task.todo;
	      });
	      var progressTasks = sortedTasks.filter(function (task, key) {
	        return task.inProgress;
	      });
	      var doneTasks = sortedTasks.filter(function (task, key) {
	        return task.done;
	      });
	      return _react2.default.createElement(
	        'div',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement('input', { type: 'text', onChange: this.handleInputChange }),
	            _react2.default.createElement(
	              'button',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_todoList.TodoList, { tasks: todoTasks, header: 'To Do', drop: this.drop, dragStart: this.dragStart, drag: this.drag, dragover: this.dragover }),
	          _react2.default.createElement(_todoList.TodoList, { tasks: progressTasks, header: 'In Progress', drop: this.drop, dragStart: this.dragStart, drag: this.drag, dragover: this.dragover }),
	          _react2.default.createElement(_todoList.TodoList, { tasks: doneTasks, header: 'Done', drop: this.drop, dragStart: this.dragStart, drag: this.drag, dragover: this.dragover })
	        )
	      );
	    }
	  }]);
	...
	function matchDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ addTask: _addTaskAction.addTask, dragDrop: _dragDropAction.dragDrop }, dispatch);
	}

	exports.default = (0, _reactRedux.connect)(mapStateToProps, matchDispatchToProps)(TasksContainer);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoList = exports.TodoList = function TodoList(props) {
	  ...
	  var renderCards = props.tasks.map(function (task, key) {
	    return _react2.default.createElement(
	      'li',
	      { key: task.id, draggable: true,
	        onDragStart: function onDragStart(event) {
	          props.dragStart(task, event);
	        },
	        onDrag: function onDrag(event) {
	          props.drag(task, event);
	        }
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: cls, onDrop: function onDrop(event) {
	        return props.drop(event);
	      }, onDragOver: function onDragOver(event) {
	        props.dragover(event);
	      } },
	    _react2.default.createElement(
	      'div',
	      { className: 'header-count-container' },
	      _react2.default.createElement(
	        'h4',
	        null,
	        props.header
...
/***/ function(module, exports) {
	...
	var addTask = exports.addTask = function addTask(taskName) {
	    return {
	        type: 'ADD_TASK',
	        payload: taskName
	    };
...
/***/ function(module, exports) {
	...
	var dragDrop = exports.dragDrop = function dragDrop(task, taskStatus) {
	    return {
	        type: 'DRAG_DROP',
	        payload: { task: task, taskStatus: taskStatus }
	    };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerTasks = __webpack_require__(207);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    ...
	    case 'DRAG_DROP':
	      debugger;
	      var taskStatus = action.payload.taskStatus;
	      switch (taskStatus) {
	        case 'inProgress':
	          var tasks = state.map(function (task) {
	...
	var data = __webpack_require__(208).data;
